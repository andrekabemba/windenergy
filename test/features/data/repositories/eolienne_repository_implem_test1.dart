...
void main() {
  ...
  // Travail Pratique (Home work)
  group("test de [authentifier]", () {
    test("devrait retourner [Succes]", () async {
      final String email = "";
    ...
    test("devrait retourner [Echec]", () async {
      final String email = "";
      final String motDePasse = "";
  ...
  group("test de [consulterEtatEolienne]", () {
    test("devrait retourner [Succes]", () async {
  ...
  group("test de [consulterListeEoliennes]", () {
    test("devrait retourner [Succes]", () async {
      when(
  ...
  group("test de [supprimerEolienne]", () {
    test("devrait retourner [Succes]", () async {
      final int idEolienne = 0;
