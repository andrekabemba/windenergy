...
void init() {
  ...
  sl.registerFactory<AuthentifierBloc>(() => AuthentifierBloc(sl()));

  sl.registerFactory<EnregistrerBloc>(() => EnregistrerBloc(sl()));
  sl.registerFactory<AjouterEolienneBloc>(() => AjouterEolienneBloc(sl()));
  ...
  sl.registerFactory<SupprimerEolienneBloc>(() => SupprimerEolienneBloc(sl()));
}
